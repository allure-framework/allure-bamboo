...
public class AllureViewReportCondition implements Condition {
    ...
    public boolean shouldDisplay(final Map<String, Object> context) {
        final String buildKey = StringUtils.defaultString((String) context.get("planKey"),
        ...
        if (buildKey != null && buildNumberString != null) {
            try {
                ...
                if (resultsSummary != null) {
                    final AllureBuildResult buildResult = fromCustomData(resultsSummary.getCustomBuildData());
