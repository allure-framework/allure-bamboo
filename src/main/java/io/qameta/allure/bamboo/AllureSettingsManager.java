...
import static io.qameta.allure.bamboo.AllureConstants.ALLURE_CONFIG_STORAGE_PATH;
...
public class AllureSettingsManager implements InitializingBean {
    ...
    public AllureGlobalConfig getSettings() {
        ...
        return new AllureGlobalConfig(
                (String) settings.get(ALLURE_CONFIG_STORAGE_PATH),
    ...
    public void saveSettings(AllureGlobalConfig config) {
        settings.put(ALLURE_CONFIG_STORAGE_PATH, config.getStoragePath());
