...
<html>
<head>
    [#assign reportUrl = "${bestBaseUrl}/plugins/servlet/allure/report/${planKey}/${buildNumber}/"]
    [#assign reportZipUrl = "${bestBaseUrl}/plugins/servlet/allure/report/${planKey}/${buildNumber}/report.zip"]
