...
public class AllureSettingsManagerTest {
    ...
    public void itShouldReadSettingsFromPluginStorage() {
        ...
        assertThat(config.isDownloadEnabled()).isFalse();
        assertThat(config.isCustomLogoEnabled()).isTrue();
        assertThat(config.isEnabledByDefault()).isTrue();
        assertThat(config.getDownloadBaseUrl()).isEqualTo("https://downloads.example/");
        assertThat(config.getLocalStoragePath()).isEqualTo("/srv/allure");
        assertThat(config.isEnabledReportsCleanup()).isTrue();
    }
    ...
    public void itShouldPersistSettingsBackToPluginStorage() {
        ...
        assertThat(storage.get(ALLURE_CONFIG_DOWNLOAD_ENABLED)).isEqualTo("false");
        assertThat(storage.get(ALLURE_CONFIG_CUSTOM_LOGO_ENABLED)).isEqualTo("true");
        assertThat(storage.get(ALLURE_CONFIG_ENABLED_BY_DEFAULT)).isEqualTo("true");
        assertThat(storage.get(ALLURE_CONFIG_DOWNLOAD_URL)).isEqualTo("https://downloads.example/");
        assertThat(storage.get(ALLURE_CONFIG_LOCAL_STORAGE)).isEqualTo("/srv/allure");
        assertThat(storage.get(ALLURE_CONFIG_REPORTS_CLEANUP_ENABLED)).isEqualTo("true");
    }
